...
public class DeleteContactTests extends TestBase {
    ...
    public void createOneAndDeleteOneContactTest() {
        ...
        app.getContactHelper().wait.until(ExpectedConditions.numberOfElementsToBeLessThan(By.className(app.getContactHelper().CONTACT_LOCATOR), sizeBefore));

        int sizeAfterDelete = app.getContactHelper().actualSizeOfContacts();
        System.out.println("Size after deletion: " + sizeAfterDelete);

     // Check that after deletion the number of contacts has decreased by 1
